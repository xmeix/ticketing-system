...
- Vous devez installer ce fichier :
  - pip install virtualenv
  - virtualenv env
  - dans bash source env/Scripts/activate
...
- python manage.py migrate
  need to check if in xampp you have the same port as in settings 
- python manage.py createsuperuser
  pass to test: lamia911
