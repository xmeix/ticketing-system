...
class TicketReponse(models.Model):
    ...
    piecesjointes = models.FileField(upload_to='replies_attachments/', blank=True, null=True)
...
class Ticket(models.Model):        
    ...
    reply = models.ForeignKey(TicketReponse, on_delete=models.CASCADE,null=True,blank=True, related_name='reponses')
